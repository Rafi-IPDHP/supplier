                        ...
                        <form action="{{ route('login.proses') }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col mb-3">
                                    ...
                                    <input type="username" name="name" class="form-control" id="username" placeholder="enter username" required>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col mb-3 input-group">
                                    <input type="password" name="password" class="form-control" id="password" placeholder="enter password" aria-describedby="basic-addon" required>
